...
##        self.SetIcon(wx.Icon('Images/horse.ico', wx.BITMAP_TYPE_ICO))
        self.panel = wx.Panel(id=PANEL_ID, name='panel', parent=self, size=wx.Size(166, 350),
        ...
        self.period_button = wx.Button(id=PERIOD_BUTTON_ID, label='.', parent=self.panel, size=wx.Size(KEYPAD_BUTTON_WIDTH, KEYPAD_BUTTON_HEIGHT))
        self.period_button.SetFont(wx.Font(16, wx.SWISS, wx.NORMAL, wx.NORMAL, False,'MS Shell Dlg 2'))
        ...
        self.del_button.SetForegroundColour(wx.RED)
        ...
        self.boxSizer2.AddSpacer(0, flag=wx.EXPAND|wx.ALL)
        ...
        self.boxSizer3.Add(self.period_button, 0, border=1, flag=wx.EXPAND|wx.ALL)
        self.boxSizer3.AddSpacer(0, flag=wx.EXPAND|wx.ALL)
        ...
        self.boxSizer4.Add(self.del_button, 0, border=1, flag=wx.EXPAND|wx.ALL)
        ...
        self.period_button.Bind(wx.EVT_BUTTON, self.OnPeriodButton)
        self.del_button.Bind(wx.EVT_BUTTON, self.OnDeleteButton)
