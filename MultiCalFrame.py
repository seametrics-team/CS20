...
#----------------------------------------------------------------------
'''
1.08    17/01/04    SPN     -Updated GetTestResults method: Implemented curve fit correction to ref volume
1.07    16/10/14    SPN     -Updated OnOPCDataChange method: added message display for C20 (safety check, test aborted)
1.06    15/04/17    SPN     -Hide clamp button
1.05    14/10/15    SPN     -Updated OnStartButton method: purge test result file
1.04    14/10/08    SPN     -Fixed bug in "test finished" event that premature stops test on last flow rate sequence
...
##            print 'replicate index:', self.replicate_index
